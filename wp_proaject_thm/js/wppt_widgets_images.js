//ADD IMAGE
		...
		$(document).on('click','.wppt_bb_img_button',function( event){
            ...
            file_frame.on('select', function() {
                ...
                // Actions
				$('.wppt_bb_custom_media_url').val(attachment.url);
				$('.wppt_bb_img').attr('src', attachment.url);
		...
		//image slider
		$(document).on('click','.wppt_imgsld_img_button',function( event){
            ...
            file_frame.on('select', function() {
                ...
                // Actions
				$('.wppt_imgsld_custom_media_url').val(attachment.url);
				$('.wppt_imgsld_img').attr('src', attachment.url);
		...
		//Gallery image 
		$(document).on('click','.wppt_gallery_img_button',function( event){
            ...
            file_frame.on('select', function() {
                ...
                // Actions
				$('.wppt_gallery_custom_media_url').val(attachment.url);
				$('.wppt_gallery_img').attr('src', attachment.url);
