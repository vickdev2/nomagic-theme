...
function custom_post_type() {
	...
	$labels = array(
		'name'                => _x( 'wppt_portfolio', 'Post_Type_General_Name'),
		'singular_name'       => _x( 'wppt_portfolio', 'Post_Type_Singular_Name'),
...
function custom_texanomies() {
	...
	$labels = array(
		'name'              => _x( 'wppt_portfolio-category', 'taxonomy_general_name' ),
		'singular_name'     => _x( 'wppt_portfolio-category', 'taxonomy_singular_name' ),
	...
	$args = array(
		...
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'wppt_portfolio-category','with_front' => false ),
		'query_var'=>true,
